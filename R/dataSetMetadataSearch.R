...
#'@details This is an example of q advanced usage. Such as q="title:youbike cost:free" , which will return the result which title contains "youbike" and cost contains "free". The method is "condition-1 condition-2 ...", which uses one blank space to separate each condition, and you can input two and more conditions to query. Please see the references for more information.
